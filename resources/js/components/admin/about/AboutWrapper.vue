<template>
  <v-container fluid grid-list-xl>
    ...
    >
      ...
      <template>
        <v-row justify="center mx-4">
          <v-expansion-panels accordion>
            <v-expansion-panel>
              <v-expansion-panel-header>Course Setup</v-expansion-panel-header>
            ...
            <v-expansion-panel>
              <v-expansion-panel-header>The Map</v-expansion-panel-header>
              <v-expansion-panel-content>
                  ...
                  <v-alert type="info" border="left" outlined v-for="icon in mapIcons" :key="icon.icon">
                    <v-row no-gutters >
                        <v-col cols="2">
            ...
            <v-expansion-panel>
              ...
              <v-expansion-panel-content>
                Need more help?  Contact us any time at <a href="mailto:golf@webfly.io">Golf@webfly.io</a>
              </v-expansion-panel-content>
            </v-expansion-panel>
